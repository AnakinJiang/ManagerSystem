        ...
        <div class="content-block" id="header">
            <div id="overlay-1">
                <header id="site-header" class="clearfix">
                    <div class="pull-left">
                        <h1><a href="#">Clouds Help For Manager</a></h1>
                    </div>
                ...
                <div class="middle text-center clearfix">
                    <div class="container"><!-- 大标题 -->
                        <h1 class="pro-name">Clouds Help For Manager</h1>
                        <p class="tagline">短时招募平台</p>
                        <br>
                        <div class="skills">
                        </div>  <!-- skills -->
                        <a href="AllMerchant.jsp" target="_parent" class="btn btn-lg btn-hire wow animated zoomIn"><font color="blue"> 所有商家 </font></a>
                        <br><br><br>
                        <a href="uncheckedMerchant.jsp" target="_parent" class="btn btn-lg btn-hire wow animated zoomIn"><font color="blue">未通过审核<br>的商家</font></a>
                    </div>  <!-- container -->
                </div>  <!-- middle -->
