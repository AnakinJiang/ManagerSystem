							...
							<section class="vbox">
								<section class="scrollable padder-lg w-f-md" id="bjax-target">
									...
									<h2 class="font-thin m-b">
										所有的商家列表 <span class="musicbar animate inline m-l-sm"
											...
											<div class="modal-content">
												<div class="form-horizontal">
													...
													<div class="modal-body">
														<fieldset>
															...
															<div class="form-group">
																...
																<div class="col-lg-10">
																	<input type="text" class="form-control" id="name" 
																		name="merchant.merchantUsername" placeholder="请输入商家昵称" value=<%=merchant.getMerchantUsername() %>>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-lg-10">
																	<input type="text" class="form-control" id="name"
																		name="merchant.merchantName" placeholder="请输入商家姓名" value=<%=merchant.getMerchantName() %>>
																</div>
															</div>
													...
													<%-- 	<button class="btn btn-sm btn-success" data-toggle="modal"
														...
														{ 
														%>
														<form action="pass" method="post" class="form-horizontal"  target="_parent">
