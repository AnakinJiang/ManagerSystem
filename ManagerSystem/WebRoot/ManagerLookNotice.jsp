							...
							<section class="vbox">
								<section class="scrollable padder-lg w-f-md" id="bjax-target">
									...
									<h2 class="font-thin m-b">
										查看并管理通知 <span class="musicbar animate inline m-l-sm"
													...
													<s:iterator value="#request.note" status="st">
														...
														<tr>
														  <form action="noticedelete" method="post">
														    <s:hidden name="notice.number" value="%{number}"/>
														    <s:hidden name="notice.yearr" value="%{yearr}"/>
														    <s:hidden name="notice.monthh" value="%{monthh}"/>
														    <s:hidden name="notice.datee" value="%{datee}"/>
															<td><s:property value="content" /></td>

															<td><s:property value="yearr" />年 <s:property
																	value="monthh" />月 <s:property value="datee" />日</td>
															<td><button class="btn btn-xs btn-danger" type="submit">删除</button></td>
														   </form>
														</tr>
													</s:iterator>
